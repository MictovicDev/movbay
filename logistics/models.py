...
class PackageDelivery(models.Model):
    ...
    sender = models.ForeignKey(UserProfile, on_delete=models.CASCADE, related_name='sender_package', blank=True, null=True)
...
class Ride(models.Model):
    ...
    order = models.ForeignKey(Order, on_delete=models.CASCADE, blank=True, null=True, related_name='ride')
    package_delivery = models.ForeignKey(PackageDelivery, on_delete=models.CASCADE, blank=True, null=True, related_name='package_delivery')
