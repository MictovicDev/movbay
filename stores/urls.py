...
urlpatterns = [
    ...
    path('delivery/', views.DeliveryDetailsCreateView.as_view(), name='delivery_details'),
    ...
    path('userproduct/<int:pk>/', views.UserProductDetailView.as_view(), name='user-product-detail'),
